...
export class DefaultHeaderComponent extends HeaderComponent {
  ...
  ngOnInit(): void {
    window['handleOauthResponse'] = this.handleOauthResponse.bind(this);
    this.getAccessAndIDToken();
  }
  ...
  //   this.httpClient.post(`${this.backend_apiUrl}/api/Login/Login`, {}, {
  //     headers: new HttpHeaders({
  //       'Authorization': `Bearer ${credential}`
  //     }),
  //     params: { token: credential } // If you want to pass the token as a query parameter
  //   }).subscribe(
  //     (res) => {
  //       console.log(res); // Handle the response
  //     },
